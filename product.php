...
if (isset($_GET['url'])) {
    ...
    $product_id_query = "SELECT id FROM products WHERE url = '$product_url' AND status = 'Published'";
...
$fetchhigh_image =$product_data['main_image'];
    ...
    <div class="d-sm-flex justify-content-between container-fluid py-new">
        <nav aria-label="breadcrumb" class="breadcrumb-row">
            <ul class="breadcrumb mb-0">
                <li class="breadcrumb-item col-or"> <a href="/">Home</a> </li>
                <li class="breadcrumb-item col-or"> <a href="our-products">Products</a> </li>
                <?php
                if (isset($getbrand['name'])) {
                ?>
                    <li class="breadcrumb-item col-or"> <a href="brands?url=<?php echo $getbrand['url'] ?>"><?php echo $getbrand['name'] ? $getbrand['name'] : ''; ?></a> </li>
                <?php
                }
                ?>
                                ...
                                <div class="swiper-wrapper" id="lightgallery">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="dz-media DZoomImage">
                                            ...
                                            <img fetchpriority="high" src="./admin/codes/<?php echo $product_data['main_image']; ?>" alt="<?php echo $image_alt; ?>">
                                        </div>
                                    </div>
            ...
            <div class="section-inner">
                ...
                <div class="row gx-3 companies-inner">
                    <div class="col-md-3 col-sm-4 col-6 p-lg-b30 p-b20 wow fadeInUp" data-wow-delay="0.1s">
                        <a href="javascript:void(0);" class="companies-wrapper">
                            <div class="companies-media">
                                <img loading="lazy" width="118px" height="118px" src="./img/certifications/dnv.webp" alt="DNV Certification">
                            </div>
                        </a>
                    </div>
                    <div class="col-md-3 col-sm-4 col-6 p-lg-b30 p-b20 wow fadeInUp" data-wow-delay="0.2s">
                        <a href="javascript:void(0);" class="companies-wrapper">
                            <div class="companies-media">
                                <img loading="lazy" width="118px" height="118px" src="https://www.mlagroup.com/img/certifications/rohs-compliant.webp" alt=" RoHS Compliant">
                            </div>
                        </a>
                    </div>
                    <div class="col-md-3 col-sm-4 col-6 p-lg-b30 p-b20 wow fadeInUp" data-wow-delay="0.3s">
                        <a href="javascript:void(0);" class="companies-wrapper">
                            <div class="companies-media">
                                <img loading="lazy" src="https://www.mlagroup.com/img/certifications/reach-compliance.webp" alt="Reach Compliance">
                            </div>
                        </a>
                    </div>
                    <div class="col-md-3 col-sm-4 col-6 p-lg-b30 p-b20 wow fadeInUp" data-wow-delay="0.4s">
                        <a href="javascript:void(0);" class="companies-wrapper">
                            <div class="companies-media">
                                <img loading="lazy" width="118px" height="118px" src="https://www.mlagroup.com/img/certifications/gmp-logo.webp" alt="Good Manufacturing Practice">
                            </div>
                        </a>
                    </div>
                    <div class="col-md-3 col-sm-4 col-6 p-lg-b30 p-b20 wow fadeInUp" data-wow-delay="0.5s">
                        <a href="javascript:void(0);" class="companies-wrapper">
                            <div class="companies-media">
                                <img loading="lazy" src="https://www.mlagroup.com/img/certifications/fda-certified.webp" alt="FDA Certified">
                            </div>
                        </a>
                    </div>
                    <div class="col-md-3 col-sm-4 col-6 p-lg-b30 p-b20 wow fadeInUp" data-wow-delay="0.6s">
                        <a href="javascript:void(0);" class="companies-wrapper">
                            <div class="companies-media">
                                <img loading="lazy" width="118px" height="118px" src="./img/certifications/eu-certified.webp" alt="EU Certified
">
                            </div>
                        </a>
                    </div>
                    <div class="col-md-3 col-sm-4 col-6 p-lg-b30 p-b20 wow fadeInUp" data-wow-delay="0.5s">
                        <a href="javascript:void(0);" class="companies-wrapper">
                            <div class="companies-media">
                                <img loading="lazy" width="118px" height="118px" src="./img/certifications/en-seven-one.webp" alt=" EN71">
                            </div>
                        </a>
                    </div>
                    <div class="col-md-3 col-sm-4 col-6 p-lg-b30 p-b20 wow fadeInUp" data-wow-delay="0.6s">
                        <a href="javascript:void(0);" class="companies-wrapper">
                            <div class="companies-media">
                                <img loading="lazy" width="118px" height="118px" src="./img/certifications/sedex-certified.webp" alt="Sedex Certified">
                            </div>
                        </a>
                    </div>
