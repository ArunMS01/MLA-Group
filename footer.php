...
<input type="hidden" class="cityname" id="cityname">
    ...
    <div class='start-chat'>
      ...
      <div class='blanter-msg'>
        ...
        <div>
          <a rel="noreferrer" id="whtasappbtn" href="https://api.whatsapp.com/send?phone=919076600122&amp;text=Hi" class="float" target="_blank">Start Chat</a>
        </div>
      </div>
    </div>
...
"></a>
            ...
            <ul class="widget-address">
              ...
              <li>
                <p><span>Phone</span> : <a class="call-open" href="javascript:void(0)">+91-9076600122 </a></p>
              </li>
            </ul>
        ...
        success: function(data) {
          ...
          $("#submit-whatsapp").text("Submit")
            ...
            if (contactmethod == 'call') {
              ...
              location.href = "tel:9076600122";

            }
            if (contactmethod == 'whatsapp') {
              location.href = "https://api.whatsapp.com/send?phone=919076600122&amp;text=Hi";
            }
...
const swiperst = new Swiper(".mySwipers1", {
    loop: true,
    spaceBetween: 20,
