                    ...
                    <div class="card-body">
                        ...
                        ?>
                            ...
                            <form id="create-category" action="admin_action.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="">URL</label>
                                    <input type="text"  class="form-control" value="<?php echo $rows['slug'] ?>"
       name="slug" id="posturl" aria-describedby="emailHelp"
       ...
       <div class="validation-error" id="urlError"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="category" id="" required>
                                        ...
                                        ?>
                                            <option value="<?php echo $rowcat['id'] ?>" <?php if ($rowcat['id'] == $rows['category']) {
                                                                                            echo "selected";
