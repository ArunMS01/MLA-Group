...
<body>
    ...
    .about-style1 .about-thumb{
        ...
        <section>
            <div class="countersss-t">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <div class="section-head style-1 wow fadeInUp text-center">
                                <h2>Few Achievements</h2>
                            </div>
                        </div>
                    </div>
                    <div class="row achivementrows">
                        ...
                        <div class="col-md-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
                            <div class="ytcounter yellow mbhgj">
                                ...
                                <h3> Highest Absorption Capacity Precipitated Silica in the world</h3>
                        ...
                        <div class="col-md-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
                            <div class="ytcounter yellow mbhgj">
                                ...
                                <h3> Lowest Bulk Density Silica</h3>
                                <!-- <span class="ytcounter-value">1243</span> -->
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
                            <div class="ytcounter yellow mbhgj">
                                ...
                                <h3> Transparent Aluminium Silicate</h3>
                                <!-- <span class="ytcounter-value">1243</span> -->
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
                            <div class="ytcounter yellow mbhgj">
                                ...
                                <h3> Zinc Oxide Active / Transparent</h3>
                                <!-- <span class="ytcounter-value">1243</span> -->
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
                            <div class="ytcounter yellow mbhgj">
                                ...
                                <h3> High Dispersible Metallic Stearates</h3>
                                <!-- <span class="ytcounter-value">1243</span> -->
                            </div>
                        </div>
