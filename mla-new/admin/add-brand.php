        ...
        <div class="main-panel">
                            ...
                            <div class="card-body">
                                ...
                                <form id="brandForm" class="forms-sample">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="editor2" placeholder="Long Description"></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="metatitle" placeholder="Meta Title" required></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="metadescription" placeholder="Meta Description" required></textarea>
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    var metatitleContainer = document.getElementById('meta-title');
                    var metadescriptionContainer = document.getElementById('meta-description');
                    ...
                    brandForm.addEventListener('submit', function(event) {
                        ...
                        formData.append('metatitle', titleInput.value);
                        formData.append('metadescription', titleInput.value);
