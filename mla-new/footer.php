...
#invalidno{
  ...
  <div class='header-chat'>
    <div class='head-home'>
      <div class='info-avatar'><img width="180px" height="109px" src='https://www.mlagroup.com/images/logo-MLA.png' alt="MLA Group" /></div>
                        ...
                        <div class="section-inner">
                            ...
                            <div class="row gx-3 companies-inner ">
                                <div class="col-md-4 col-sm-4 col-6 p-lg-b30 p-b20 wow fadeInUp " data-wow-delay="0.1s">
                                    <a href="javascript:void(0);" class="companies-wrapper">
                                        <div class="companies-media">
                                            <img height="43" width="94" src="images/01.webp" alt="" class="logo-foot">
                                        </div>
                                    </a>
                                </div>
                                <div class="col-md-4 col-sm-4 col-6 p-lg-b30 p-b20 wow fadeInUp" data-wow-delay="0.2s">
                                    <a href="javascript:void(0);" class="companies-wrapper">
                                        <div class="companies-media">
                                            <img height="43" width="94" src="images/02.webp" alt="" class="logo-foot">
                                        </div>
                                    </a>
                                </div>
                                <div class="col-md-4 col-sm-4 col-6 p-lg-b30 p-b20 wow fadeInUp" data-wow-delay="0.3s">
                                    <a href="javascript:void(0);" class="companies-wrapper">
                                        <div class="companies-media">
                                            <img height="43" width="94" src="images/03.webp" alt="" class="logo-foot">
                                        </div>
                                    </a>
                                </div>
                                <div class="col-md-4 col-sm-4 col-6 p-lg-b30 p-b20 wow fadeInUp" data-wow-delay="0.4s">
                                    <a href="javascript:void(0);" class="companies-wrapper">
                                        <div class="companies-media">
                                            <img height="43" width="94" src="images/04.webp" alt="" class="logo-foot">
                                        </div>
                                    </a>
                                </div>
                                <div class="col-md-4 col-sm-4 col-6 p-lg-b30 p-b20 wow fadeInUp" data-wow-delay="0.5s">
                                    <a href="javascript:void(0);" class="companies-wrapper">
                                        <div class="companies-media">
                                            <img height="43" width="94" src="images/05.webp" alt="" class="logo-foot">
                                        </div>
                                    </a>
                                </div>
                                <div class="col-md-4 col-sm-4 col-6 p-lg-b30 p-b20 wow fadeInUp" data-wow-delay="0.6s">
                                    <a href="javascript:void(0);" class="companies-wrapper">
                                        <div class="companies-media">
                                            <img height="43" width="94" src="images/06.webp" alt="" class="logo-foot">
                                        </div>
                                    </a>
                                </div>
                                <div class="col-md-4 col-sm-4 col-6 p-lg-b30 p-b20 wow fadeInUp" data-wow-delay="0.6s">
                                    <a href="javascript:void(0);" class="companies-wrapper">
                                        <div class="companies-media">
                                            <img height="43" width="94" src="images/plastvision.webp" alt="" class="logo-foot">
                                        </div>
                                    </a>
                                </div>
                                <div class="col-md-4 col-sm-4 col-6 p-lg-b30 p-b20 wow fadeInUp" data-wow-delay="0.6s">
                                    <a href="javascript:void(0);" class="companies-wrapper">
                                        <div class="companies-media">
                                            <img height="43" width="94" src="images/irexpo.webp" alt="" class="logo-foot">
                                        </div>
                                    </a>
                                </div>
                                  ...
                                  <div class="col-md-4 col-sm-4 col-6 p-lg-b30 p-b20 wow fadeInUp" data-wow-delay="0.6s">
                                    <a href="javascript:void(0);" class="companies-wrapper">
                                        <div class="companies-media">
                                            <img height="43" width="94" src="images/cphlindia.webp" alt="" class="logo-foot">
                                        </div>
                                    </a>
                                </div>
