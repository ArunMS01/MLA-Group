                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" style="height: 300px;" rows="10" id="exampleInputAdditionalCode" placeholder="Additional Code"><?php echo $additionalCode; ?></textarea>
...
<div class="form-group">
 ...
 <div class="col-md-12 grid-margin stretch-card">
        ...
        CKEDITOR.replace('editor2',{
               height: 300,
            allowedContent: true,
            filebrowserUploadUrl: "https://mlagroup.com/admin/uploadns.php"
        });
